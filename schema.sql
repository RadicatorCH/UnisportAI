-- =====================================================================
-- UnisportAI - Simplified Database Schema (Tables + Views)
-- =====================================================================
-- This script creates a simpler version of the UnisportAI schema:
--   - No custom ENUM types (plain text columns instead)
--   - Minimal CHECK constraints
--   - Same tables and views as the main schema, compatible with the code
--
-- Use this version if you want a more beginner-friendly SQL script
-- without advanced PostgreSQL features like ENUM types or DO $$ blocks.
-- =====================================================================
